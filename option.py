...
parser.add_argument('--rgb-list', default='list/rgb_3.list', help='list of rgb features ')
parser.add_argument('--flow-list', default='list/flow__3.list', help='list of flow features')
parser.add_argument('--audio-list', default='list/audio__3.list', help='list of audio features')
parser.add_argument('--test-rgb-list', default='list/rgb_test_3.list', help='list of test rgb features ')
parser.add_argument('--test-flow-list', default='list/flow_test__3.list', help='list of test flow features')
parser.add_argument('--test-audio-list', default='list/audio_test__3.list', help='list of test audio features')
parser.add_argument('--dataset-name', default='XD-Violence', help='dataset to train on XD-Violence')
parser.add_argument('--gt', default='list/gt__3.npy', help='file of ground truth ')
...
parser.add_argument('--batch-size', type=int, default=120, help='number of instances in a batch of data')
parser.add_argument('--workers', default=8, help='number of workers in dataloader')
parser.add_argument('--model-name', default='xd_a2v__1_3', help='name to save model')
